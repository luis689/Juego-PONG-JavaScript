...
class Play3 extends Phaser.Scene {
    ...
    create() {
        ...
        // Agregar obstaculos
        this.plataforma1 = new Obstaculo(this, 180, 400, "plataforma")
        this.plataforma2 = new Obstaculo(this, 400, 100, "plataforma")
        this.plataforma3 = new Obstaculo(this, 220, 200, "plataforma")
        this.plataforma4 = new Obstaculo(this, 500, 450, "plataforma")
        this.plataforma5 = new Obstaculo(this, 100, 50, "plataforma")
        ...
        this.physics.add.collider(this.ball,this.plataforma1,this.choque, null, this);// Se llama a la funcion choque, cuando la bola choca con algun obstaculo
        this.physics.add.collider(this.ball,this.plataforma2,this.choque, null, this);
        this.physics.add.collider(this.ball,this.plataforma3,this.choque, null, this);
        this.physics.add.collider(this.ball,this.plataforma4,this.choque, null, this);
        this.physics.add.collider(this.ball,this.plataforma5,this.choque, null, this);
    ...
    update() {
        ...
        if(puntos1 == 5 || puntos2 == 5){                                   // Evalua si alguno de los dos jugadores llega a 5 puntos
            this.scene.start('Menu');                                       // Se llama a la escena Menu 
        }
